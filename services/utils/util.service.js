...
export const ReE = (res, err, code = errorCode.BAD_REQUEST, errCode = errorCode.SOMETHINGS_WENT_WRONG) => { // Error Web Response
  let error = err
...
export const ReS = (res, data, code = errorCode.SUCCESS) => { // Success Web Response
  let sendData
...
export const TE = (errMessage, log = false, errorCode = null) => { // TE stands for Throw Error
  if (log === true) {
